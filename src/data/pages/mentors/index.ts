...
export const mentorBoxCarousel = [
  ...
  {
    icon: 'ph:mouse-simple-duotone',
    title: 'PPC Base Planning',
    link: '/',
  },
  {
...
export const mentorStats = [
  {
    ...
    suffix: '+',
    value: 950,
    text: 'Registered and active mentors',
  },
  {
    id: 1,
    prefix: '$',
    suffix: 'B',
    value: 8,
    text: 'Value generated in sales annually',
  },
  {
    id: 2,
    prefix: '',
  ...
  },
  {
    ...
    suffix: 'M',
    value: 279,
    text: 'Funds spent annually on recruiting mentors',
  },
]
