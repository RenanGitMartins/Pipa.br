...
export const vulkBenefits: CompleteFeature[] = [
  {
    title: 'Mapa Pipas BR',
    subtitle: 'Encontre tudo de pipa',
    text: 'Encontre no mapa do brasil o que você está procurando, lojas, próximos festivais, próximos campeonatos, locais de pipas frequêntes',
    icon: 'feather:map',
  },
  {
    title: 'Ranking',
    subtitle: 'Seja o melhor pipeiro do brasil',
    text: 'Participe de campeonatos, festivais, conquiste medalhas dentro do pipas br e fique no top 1 do Brasil!',
    icon: 'feather:award',
  },
  {
    title: 'Lojistas',
    subtitle: 'Gerencie suas Lojas',
    text: 'Adicione sua loja ao mapa pipas br, acompanhe relatórios de visualizações, comentários, curtidas',
    icon: 'feather:database',
  },
  {
    title: 'Produtores de Conteúdo',
    subtitle: 'Publique no nosso blog',
    text: 'Faça publicações, acompanhe relatórios de visualizções, ganhe seguidores e fique conhecido nacionalmente.',
    icon: 'feather:layout',
  },
  {
    title: '600+ Components',
