        ...
        <div class="card-wrapper">
          <div class="columns is-vcentered">
            <div class="column is-7 is-hidden-mobile">
              <DarkImage src="/assets/illustrations/hero/signup-hero.svg"
                src-dark="/assets/illustrations/hero/signup-hero.svg" alt="Signup hero
            image" />
            </div>
            <div class="column is-5">
              <div class="form-card">
                <div class="auth-head">
                  ...
                  <RouterLink to="/login" class="rem-90">
