...
<template>
  <div class="blog-recent-posts">
    <Title tag="h3" :size="5" weight="semi">
      <span>Pipeiros Destaque</span>
    </Title>

    <div class="blog-recent-posts-inner">
      <div v-for="(post, index) in props.pipeiros.slice(0, props.limit)" :key="index"
        ...
        <div class="post-content">
          <Title tag="h3" :size="7" weight="semi" leading>
            <span>Ganhador de + campeonatos</span>
  ...
  <div class="blog-recent-posts">
    <Title tag="h3" :size="5" weight="semi">
      <span>Linhas Destaque</span>
    </Title>

    <div class="blog-recent-posts-inner">
      <div v-for="(post, index) in props.linhas.slice(0, props.limit)" :key="index"
        class="blog-recent-post">
        <div class="post-image">
          <img :src="post.image" alt="Post thumbnail" />
        </div>
