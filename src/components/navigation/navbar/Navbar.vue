  ...
  <nav ref="navbar" class="navbar is-transparent is-fixed-top is-fade" role="navigation" aria-label="main navigation"
    ...
    <div class="container">
      <div class="navbar-brand">
        <!-- <RouterLink v-preload-link class="navbar-item" to="/" style="border: 1px solid; width: 95px"> -->
          <div class="navbar-item">
            <img class="navbar-logo" src="/assets/logo/logo.png" alt="logo"/>
          </div>
        <!-- </RouterLink> -->
        <div class="navbar-burger" @click.prevent="isNavbarOpen = !isNavbarOpen"
      ...
      <div class="navbar-menu b-centered-mobile b-centered-tablet-p" :class="[isNavbarOpen && 'is-active']">
        <div class="navbar-end">
          ...
          <div class="navbar-item">
            ...
            <Button elevated bold :long="2" icon-left="teenyicons:wallet-alt-outline">
              Acessar Painel
            </Button>
          </a>
          </div>
    ...
    <div class="megamenu" :class="[isMegamenuOpen && 'is-active']">
      <ProductMegamenu v-if="activeDropdown === 'product-drop'" @close="() => selectMobileMenu()" />
