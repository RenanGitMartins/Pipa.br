        ...
        <div class="column is-5">
          <div class="hero-caption">
            ...
            <div class="authors">
              ...
              <div class="meta">
                <h3>100+</h3>
                <p class="paragraph rem-85">Top NFT authors</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="hero-composition-container">
            <div class="columns b-columns-half-tablet-p">
              <div class="column is-6">
                ...
                <div class="nft-card">
                  <DarkImage
                    src="/assets/demo/img/nft/monkey-1.jpg"
                    alt="NFT image"
                    width="600"
                    height="510"
                  />
                  <div class="card-head">
                    <AvatarSimple picture="/assets/nft/avatars/egg.svg" />
                    <Title tag="h3" :size="6" weight="semi">
                      The cool crypto monkey
                    </Title>
                  </div>
                  <div class="card-foot">
                    <div class="price">
              ...
              <div class="column is-6">
                ...
                <div class="nft-card">
                  <DarkImage
                    src="/assets/demo/img/nft/monkey-2.png"
                    alt="NFT image"
                    width="600"
                    height="510"
                  />
